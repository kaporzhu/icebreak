...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_address', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Address', fields ['user']
        db.create_unique(u'accounts_address', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Address', fields ['user']
        db.delete_unique(u'accounts_address', ['user_id'])


        # Changing field 'Address.user'
        db.alter_column(u'accounts_address', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Staff.is_deliveryman'
        db.delete_column(u'accounts_staff', 'is_deliveryman')

        # Deleting field 'Staff.is_shop_manager'
        db.delete_column(u'accounts_staff', 'is_shop_manager')

        # Adding field 'Staff.role'
        db.add_column(u'accounts_staff', 'role',
                      self.gf('django.db.models.fields.CharField')(default='delivery man', max_length=16),
                      keep_default=False)

        # Adding field 'Staff.intro'
        db.add_column(u'accounts_staff', 'intro',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Staff.is_deliveryman'
        db.add_column(u'accounts_staff', 'is_deliveryman',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Adding field 'Staff.is_shop_manager'
        db.add_column(u'accounts_staff', 'is_shop_manager',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Deleting field 'Staff.role'
        db.delete_column(u'accounts_staff', 'role')

        # Deleting field 'Staff.intro'
        db.delete_column(u'accounts_staff', 'intro')

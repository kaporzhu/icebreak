...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.shop'
        db.add_column(u'coupons_coupon', 'shop',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shops.Shop'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coupon.creator'
        db.add_column(u'coupons_coupon', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shop_coupons', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.shop'
        db.delete_column(u'coupons_coupon', 'shop_id')

        # Deleting field 'Coupon.creator'
        db.delete_column(u'coupons_coupon', 'creator_id')

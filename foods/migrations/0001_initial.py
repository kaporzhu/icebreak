...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'foods_food', (
            ...
            ('count_today', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ...
        # Adding model 'FoodComment'
        db.create_table(u'foods_foodcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('food', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foods.Food'])),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Address'], null=True, blank=True)),
            ('rating', self.gf('django.db.models.fields.CharField')(default='delicious', max_length=16, db_index=True)),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'foods', ['FoodComment'])

        # Adding model 'TimeFrame'
        db.create_table(u'foods_timeframe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shops.Shop'])),
        ...
        db.send_create_signal(u'foods', ['TimeFrame'])

        # Adding M2M table for field foods on 'TimeFrame'
        m2m_table_name = db.shorten_name(u'foods_timeframe_foods')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('timeframe', models.ForeignKey(orm[u'foods.timeframe'], null=False)),
            ('food', models.ForeignKey(orm[u'foods.food'], null=False))
        ))
        db.create_unique(m2m_table_name, ['timeframe_id', 'food_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FoodComment'
        db.delete_table(u'foods_foodcomment')

        # Deleting model 'TimeFrame'
        db.delete_table(u'foods_timeframe')

        # Removing M2M table for field foods on 'TimeFrame'
        db.delete_table(db.shorten_name(u'foods_timeframe_foods'))
    ...
    models = {
        ...
        u'foods.foodcomment': {
            'Meta': {'object_name': 'FoodComment'},
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Address']", 'null': 'True', 'blank': 'True'}),
            'content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'food': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['foods.Food']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.CharField', [], {'default': "'delicious'", 'max_length': '16', 'db_index': 'True'})
        },
        u'foods.timeframe': {

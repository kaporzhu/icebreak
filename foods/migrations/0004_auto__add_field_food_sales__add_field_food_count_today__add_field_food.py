...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Food.sales'
        db.add_column(u'foods_food', 'sales',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Food.count_today'
        db.add_column(u'foods_food', 'count_today',
    ...
    def backwards(self, orm):
        # Deleting field 'Food.sales'
        db.delete_column(u'foods_food', 'sales')

        # Deleting field 'Food.count_today'
        db.delete_column(u'foods_food', 'count_today')

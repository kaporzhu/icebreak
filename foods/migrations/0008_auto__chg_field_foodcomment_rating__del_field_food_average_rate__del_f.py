...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoodComment.rating'
        db.alter_column(u'foods_foodcomment', 'rating', self.gf('django.db.models.fields.CharField')(max_length=16))
        # Deleting field 'Food.average_rate'
        db.delete_column(u'foods_food', 'average_rate')

        # Deleting field 'Food.rate_count'
        db.delete_column(u'foods_food', 'rate_count')


    def backwards(self, orm):

        # Changing field 'FoodComment.rating'
        db.alter_column(u'foods_foodcomment', 'rating', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
        # Adding field 'Food.average_rate'
        db.add_column(u'foods_food', 'average_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Food.rate_count'
        db.add_column(u'foods_food', 'rate_count',
    ...
    models = {
        ...
        u'foods.foodcomment': {
            ...
            'food': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['foods.Food']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.CharField', [], {'default': "'delicious'", 'max_length': '16'})
        },
        u'foods.timeframe': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shop'
        db.add_column(u'orders_order', 'shop',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shops.Shop'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.delivery_man'
        db.add_column(u'orders_order', 'delivery_man',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Staff'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shop'
        db.delete_column(u'orders_order', 'shop_id')

        # Deleting field 'Order.delivery_man'
        db.delete_column(u'orders_order', 'delivery_man_id')

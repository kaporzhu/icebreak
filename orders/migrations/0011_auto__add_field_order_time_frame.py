...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.time_frame'
        db.add_column(u'orders_order', 'time_frame',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['foods.TimeFrame'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.time_frame'
        db.delete_column(u'orders_order', 'time_frame_id')
